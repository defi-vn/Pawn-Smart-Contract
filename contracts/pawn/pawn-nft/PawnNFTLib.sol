...
library PawnNFTLib {
    ...
    */
    ...
    function calculatedueDateTimestampInterest(IPawnNFT.LoanDurationType durationType) 
    internal pure 
    ...
    function calculatedueDateTimestampPenalty(IPawnNFT.LoanDurationType durationType) 
    internal pure 
    returns(uint256 duedateTimestampInterest)
    {
        if(durationType == IPawnNFT.LoanDurationType.WEEK) {
